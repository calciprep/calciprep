...
const Header = () => {
  ...
  return (
    ...
    >
      <div className={`max-w-7xl mx-auto overflow-hidden bg-white/40 backdrop-blur-xl border border-white/20 shadow-lg transition-all duration-500 ${isMenuOpen ? 'rounded-3xl' : 'rounded-full'}`}>
                ...
                <div className="hidden md:flex items-center space-x-2">
                    {currentUser ? (
                      <div className="relative" ref={accountMenuRef}>
                        <button onClick={() => setAccountMenuOpen(prev => !prev)} className="w-10 h-10 rounded-full bg-purple-100 flex items-center justify-center text-purple-600">
                           <User />
                        </button>
                        {isAccountMenuOpen && (
