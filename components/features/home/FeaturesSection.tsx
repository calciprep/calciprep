...
const FeaturesSection = () => {
  ...
  useEffect(() => {
    ...
    let cardStreamController: CardStreamController;
    let particleSystem: ParticleSystem;
    let particleScanner: ParticleScanner;
    ...
    class ParticleSystem {
        ...
        constructor() { 
            ...
            this.camera = new THREE.OrthographicCamera(featuresSection!.offsetWidth / -2, featuresSection!.offsetWidth / 2, featuresSection!.offsetHeight / 2, featuresSection!.offsetHeight / -2, 1, 1000); 
            this.camera.position.z = 100; 
            this.renderer = new THREE.WebGLRenderer({ canvas: particleCanvas, alpha: true }); 
            this.renderer.setSize(featuresSection!.offsetWidth, featuresSection!.offsetHeight); 
        ...
        createParticles() {
            ...
            for (let i = 0; i < this.pCount; i++) {
                pos[i * 3] = (Math.random() - 0.5) * featuresSection!.offsetWidth * 2;
        ...
        animate() { 
            ...
            for (let i = 0; i < this.pCount; i++) { 
                pos[i * 3] += this.vel[i]; 
                if (pos[i * 3] > featuresSectionRef.current.offsetWidth / 2 + 50) {
                    pos[i * 3] = -featuresSectionRef.current.offsetWidth / 2 - 50;
                }
            } 
      ...
      <div className="beam-container relative">
        ...
        <div className="card-stream">
          <div className="card-line" ref={cardLineRef}>
            {/* Cards will be populated here by the script */}
          </div>
        </div>
      </div>
    </section>
