...
export default function SSCCGL_LiveResultPage() {
  ...
  useEffect(() => {
    // 1. Grab the result generated by your CGLInterface/TCSMode
    const savedResult = sessionStorage.getItem('liveTestResult');
    
    if (savedResult) {
      const parsedResult = JSON.parse(savedResult);
      // Ensure the category is attached so your TypingResult component routes it to CGLResult.tsx
  ...
  const saveScoreToLeaderboard = async (stats: TypingResultType) => {
    try {
      ...
      // UNIQUE FIRESTORE COLLECTION FOR CGL
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans pt-[90px] pb-20 px-4">
      <div className="max-w-5xl mx-auto">
        ...
        {/* Your Custom Typing Result Component (Which routes to CGLResult) */}
