...
export default function SSCCGL_LiveLeaderboard() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans pt-[100px] pb-20">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <button onClick={() => router.push('/live-tests/typing/ssc_cgl')} className="flex items-center text-slate-500 hover:text-slate-900 font-bold mb-8 transition-colors">
