      ...
      <div className="max-w-4xl mx-auto bg-white p-8 md:p-12 rounded-2xl shadow-sm">
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            Welcome to CalciPrep (&quot;we,&quot; &quot;us,&quot; or &quot;our&quot;). We are committed to protecting your personal information and your right to privacy. If you have any questions or concerns about this privacy notice, or our practices with regards to your personal information, please contact us at contact@calciprep.online.
          </p>
        </section>
