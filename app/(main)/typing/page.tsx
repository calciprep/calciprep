...
export default function TypingSelectionPage() {
  return (
      ...
      <div className="rounded-2xl bg-gradient-to-r from-amber-500 to-orange-500 p-8 md:p-12">
        <div className="grid md:grid-cols-2 items-center gap-8">
          ...
          <div className="hidden md:flex justify-center items-center">
            <Image src={typingIllustration} alt="Typing Arena Illustration" className="h-56 w-auto" priority />
          </div>
        </div>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto mt-12">
        <Link href="/typing/learn" className="category-card bg-purple-100">
        ...
        <Link href="/typing/test" className="category-card bg-blue-100">
            <div className="p-8 text-center flex flex-col flex-grow">
