...
const MathsGamePage = () => {
  ...
  return (
    <div className="container mx-auto px-6 py-28">
      <Helmet>
        <title>Maths Game - Practice Speed & Accuracy | CalciPrep</title>
        <meta name="description" content="Engage in timed maths challenges to boost your calculation speed and accuracy. Choose from various modes and difficulty levels to suit your practice needs." />
      </Helmet>
